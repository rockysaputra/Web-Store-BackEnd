...
Route::get('/dashboard/settings', 'DashboardSettingController@store')->name('dashboa-setting-store');
Route::get('/dashboard/account', 'DashboardSettingController@account')->name('dashboa-setting-account');
